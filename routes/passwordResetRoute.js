...
export default function PasswordReset() {
    ...
    const handleRequestVerification = async (e) => {
        ...
        try {
            const response = await axios.post("http://localhost:4000/api/v1/auth/request-reset", {
                accountType: field,
    ...
    const handleVerifyCode = async (e) => {
        ...
        try {
            const response = await axios.post("http://localhost:4000/api/v1/auth/verify-reset-code", {
                accountType: field,
                method: verificationMethod,
                email: formData.email,
                phone: formData.phone,
